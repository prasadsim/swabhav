...
public class PersonTest {
	public static void main(String agrs[]) {
		Person p1 = new Person("ASH", 50, "Male", 6.5f, 100f);
		printInfo(p1);
		p1.doWorkout();
		...
		Person p2 = new Person(null, -50, "abc", -6.5f, -100f);
		printInfo(p2);
		p2.doWorkout();
	...
	private static void printInfo(Person p) {
		...
		System.out.println("BMI Value:"+p.calculateBmi());
		System.out.println("BMI Cateory:"+p.bmiCategory());
	}
}
