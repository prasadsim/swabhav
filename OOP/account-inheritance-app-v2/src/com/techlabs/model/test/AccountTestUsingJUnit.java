...
class AccountTestUsingJUnit {
	...
	public void test_ifAccountHolderIsCurrentOrSaving() throws ParseException {
		...
		// Act
		Class<SavingAccount> exceptedAccountClassOfSaving = SavingAccount.class;
		SavingAccount actualAccountClasssOfSaving = sa1;
		Class<CurrentAccount> exceptedAccountClassOfCurrent = CurrentAccount.class;
		CurrentAccount actualAccountClasssOfCurrent = ca1;

		// Assert
		assertEquals(exceptedAccountClassOfSaving, actualAccountClasssOfSaving.getClass());
		assertEquals(exceptedAccountClassOfCurrent, actualAccountClasssOfCurrent.getClass());
